        ...
        try {
            ...
            let query = `
                ...
                SELECT C.CONTENT_ID,
                       ...
                       UPVOTE_COUNT,
                       DOWNVOTE_COUNT,
                       P2.FIRST_NAME || ' ' || p2.LAST_NAME as POSTED_BY,
                       VOTED.DOWN,
                       T.ROLE_ID                            as TEACHER,
                       S.ROLE_ID                            as STUDENT,
                ...
                FROM (
                         ...
                         LEFT OUTER JOIN DEPARTMENT D
                                         on D.DEPARTMENT_ID = T.DEPARTMENT_ID OR D.DEPARTMENT_ID = S.DEPARTMENT_ID
            ...
            let query = `
                ...
                FROM (
                         ...
                         WHERE C.CONTENT_ID = :cId
                           AND EXISTS(SELECT *
                                      FROM GROUP_MEMBER GM
                                      WHERE GM.ROLE_ID = :rId AND GM.GROUP_ID = C.GROUP_ID)
